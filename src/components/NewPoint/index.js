      ...
      >
        ...
        >
          ...
          >
            ...
            <TextInput
              style={styles.inputInfo}
              onChangeText={profundidade_inicial =>
                this.setState({ profundidade_inicial })
              }
            ...
            <TextInput
              style={styles.inputInfo}
              onChangeText={profundidade_final =>
                this.setState({ profundidade_final })
              }
            ...
            <TextInput
              style={styles.inputInfo}
              onChangeText={diametro_da_boca =>
                this.setState({ diametro_da_boca })
              }
            ...
            <TextInput
              style={styles.inputInfo}
              onChangeText={tipo_penetracao =>
                this.setState({ tipo_penetracao })
              }
            ...
            <TextInput
              style={styles.inputInfo}
              onChangeText={vazao_especifica =>
                this.setState({ vazao_especifica })
              }
          ...
          <TouchableOpacity
            style={{
              backgroundColor: `${
                this.state.option === "1" ? "#4285f4" : "#E5454C"
              }`,
              width: "95%",
              bottom: 10,
              left: 10,
